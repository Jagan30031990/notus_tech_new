    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-3">
        ...
        <div className="text-center mb-24">
          <div className={`inline-flex items-center px-6 py-3 bg-white/90 backdrop-blur-sm border border-blue-200 text-blue-700 rounded-full text-sm font-medium mb-8 shadow-lg transition-all duration-1000 hover:scale-110 cursor-pointer ${isVisible ? 'animate-slideInDown' : 'opacity-0'}`}>
            <i className="ri-star-line mr-3 text-lg text-blue-500 animate-spin" style={{ animationDuration: '4s' }}></i>
            Why Choose Notus Technologies
            <div className="w-2 h-2 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-full ml-3 animate-pulse"></div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-20">
          {features.map((feature, index) => (
            <div 
              key={index} 
              className={`group relative bg-white/95 backdrop-blur-sm rounded-3xl p-10 shadow-xl hover:shadow-2xl transition-all duration-700 cursor-pointer border border-blue-100 overflow-hidden transform hover:scale-105 hover:-rotate-1 ${
                activeFeature === index ? 'ring-4 ring-blue-300/50 ring-offset-4 scale-105' : ''
            ...
            >
              ...
              {/* Blue themed icon */}
              <div className="relative w-20 h-20 flex items-center justify-center bg-gradient-to-r from-blue-500 to-indigo-600 rounded-3xl mb-8 group-hover:scale-125 group-hover:rotate-12 transition-all duration-500 shadow-lg group-hover:shadow-2xl mx-auto">
                <i className={`${feature.icon} text-3xl text-white group-hover:animate-bounce`}></i>
                <div className="absolute inset-0 bg-white/20 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>

                {/* Blue pulsing ring effect */}
                <div className="absolute inset-0 rounded-3xl bg-gradient-to-r from-blue-500 to-indigo-600 opacity-20 animate-ping group-hover:animate-pulse"></div>
              </div>

              {/* Content */}
              <div className="relative z-10 text-center">
                <h3 className="text-xl font-bold text-slate-900 mb-5 group-hover:text-blue-700 transition-colors duration-300 leading-tight">
                  {feature.title}
                </h3>
                ...
                <div className="flex items-center justify-between pt-6 border-t border-blue-100 group-hover:border-blue-200 transition-colors duration-300">
                  <div className="text-left">
                    ...
                    <div className="text-sm text-slate-500 group-hover:text-slate-600 transition-colors">{feature.stats.label}</div>
                  </div>
                  <div className="w-10 h-10 flex items-center justify-center bg-blue-100 rounded-full group-hover:bg-blue-200 group-hover:scale-125 transition-all duration-300 cursor-pointer">
                    <i className="ri-arrow-right-line text-blue-600 group-hover:text-blue-700 group-hover:translate-x-1 transition-all duration-300"></i>
                  </div>
                </div>
        ...
        <div className={`bg-white/95 backdrop-blur-sm rounded-3xl p-16 shadow-2xl border border-blue-200 transition-all duration-1000 delay-1200 hover:scale-105 cursor-pointer group ${isVisible ? 'animate-slideInUp' : 'opacity-0'}`}>
          <div className="text-center mb-10">
            <div className="flex justify-center mb-6">
              {[...Array(5)].map((_, i) => (
                <i 
                  key={i} 
                  className="ri-star-fill text-3xl mx-1 animate-pulse group-hover:animate-bounce text-blue-400"
                  style={{ animationDelay: `${i * 0.1}s` }}
                ></i>
              ))}
            </div>
            <blockquote className="text-3xl md:text-4xl font-medium text-slate-900 mb-8 italic leading-relaxed group-hover:text-slate-800 transition-colors duration-500">
            ...
            <div className="flex items-center justify-center space-x-6 group-hover:scale-105 transition-transform duration-300">
              <img 
                ...
                alt="CEO"
                className="w-16 h-16 rounded-full object-cover border-4 border-blue-200 group-hover:border-blue-300 transition-colors duration-300"
              />
              <div className="text-left">
                <div className="font-semibold text-slate-900 text-lg group-hover:text-slate-700 transition-colors">Sarah Johnson</div>
                <div className="text-slate-600 group-hover:text-slate-700 transition-colors">CEO, TechCorp Inc.</div>
                <div className="text-sm text-slate-500">Fortune 500 Company</div>
              </div>
            </div>
          </div>

          <div className="flex items-center justify-center space-x-16 opacity-80 group-hover:opacity-100 transition-opacity duration-300">
            <div className="text-center group/stat hover:scale-110 transition-transform duration-300">
              <div className="text-3xl font-bold bg-gradient-to-r from-blue-500 to-indigo-600 bg-clip-text text-transparent">150+</div>
              <div className="text-sm text-slate-600">Happy Clients</div>
            </div>
            <div className="w-1 h-10 bg-gradient-to-b from-blue-300 to-indigo-500 rounded-full"></div>
            <div className="text-center group/stat hover:scale-110 transition-transform duration-300">
              <div className="text-3xl font-bold bg-gradient-to-r from-blue-500 to-indigo-600 bg-clip-text text-transparent">500+</div>
              <div className="text-sm text-slate-600">Successful Projects</div>
            </div>
            <div className="w-1 h-10 bg-gradient-to-b from-blue-300 to-indigo-500 rounded-full"></div>
            <div className="text-center group/stat hover:scale-110 transition-transform duration-300">
              <div className="text-3xl font-bold bg-gradient-to-r from-blue-500 to-indigo-600 bg-clip-text text-transparent">99%</div>
              <div className="text-sm text-slate-600">Success Rate</div>
            </div>
            <div className="w-1 h-10 bg-gradient-to-b from-blue-300 to-indigo-500 rounded-full"></div>
            <div className="text-center group/stat hover:scale-110 transition-transform duration-300">
              <div className="text-3xl font-bold bg-gradient-to-r from-blue-500 to-indigo-600 bg-clip-text text-transparent">24/7</div>
