...
export default function FAQSection() {
  ...
  return (
    <section ref={sectionRef} className="relative py-28 bg-gradient-to-br from-blue-50 via-indigo-50 to-blue-100 overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-6">
        ...
        <div className="text-center mb-20">
          <div className={`inline-flex items-center px-6 py-3 bg-white/90 backdrop-blur-sm border border-blue-200 text-blue-700 rounded-full text-sm font-semibold mb-8 transition-all duration-1000 hover:scale-105 cursor-pointer ${isVisible ? 'animate-slideInDown' : 'opacity-0'}`}>
          ...
          <h2 className={`text-5xl md:text-6xl font-bold mb-8 transition-all duration-1000 delay-300 ${isVisible ? 'animate-slideInUp' : 'opacity-0'}`}>
            <span className="bg-gradient-to-r from-blue-600 via-indigo-600 to-blue-700 bg-clip-text text-transparent">
              Got Questions?
            </span>
          </h2>
          <p className={`text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed transition-all duration-1000 delay-500 ${isVisible ? 'animate-slideInUp' : 'opacity-0'}`}>
          ...
          {faqs.map((faq, index) => (
            ...
            >
              <button
                ...
                className="w-full px-8 py-6 text-left flex items-center justify-between hover:bg-blue-50/50 transition-all duration-300 cursor-pointer group-hover:scale-[1.02]"
              >
                <h3 className="text-lg font-semibold text-gray-900 group-hover:text-blue-600 transition-colors duration-300 pr-4">
                  {faq.question}
                </h3>
                <div className={`w-8 h-8 flex items-center justify-center bg-blue-100 rounded-full flex-shrink-0 transition-all duration-300 ${openFAQ === index ? 'bg-blue-600 rotate-180' : 'group-hover:bg-blue-200'}`}>
                  <i className={`ri-arrow-down-line text-lg transition-colors duration-300 ${openFAQ === index ? 'text-white' : 'text-blue-600'}`}></i>
                </div>
              </button>
        ...
        <div className={`text-center mt-16 transition-all duration-1000 delay-1200 ${isVisible ? 'animate-slideInUp' : 'opacity-0'}`}>
          <div className="bg-gradient-to-br from-blue-600 to-indigo-600 rounded-3xl p-12 relative overflow-hidden group hover:scale-105 transition-all duration-500 cursor-pointer">
            ...
            <div className="relative z-10">
              <div className="inline-flex items-center px-6 py-3 bg-white/20 backdrop-blur-md rounded-full border border-white/30 mb-6 group-hover:scale-110 transition-all duration-300">
                <i className="ri-customer-service-line text-white mr-3"></i>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <button className="bg-white text-blue-600 px-8 py-4 rounded-2xl font-semibold text-lg transition-all duration-300 cursor-pointer whitespace-nowrap hover:shadow-2xl hover:scale-110 group/btn">
                  <span className="flex items-center justify-center">
                    <i className="ri-phone-line mr-3 group/btn:hover:animate-bounce"></i>
                    Schedule Free Call
                  </span>
                </button>
                <button className="border-2 border-white/50 text-white px-8 py-4 rounded-2xl font-semibold text-lg transition-all duration-300 cursor-pointer whitespace-nowrap hover:bg-white/10 hover:scale-110">
                  <span className="flex items-center justify-center">
