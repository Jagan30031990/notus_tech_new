...
export default function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-blue-100 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-3 min-h-screen flex items-center">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center w-full">
          ...
          <div className={`transition-all duration-1000 transform ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-12'}`}>
            {/* Enhanced badge */}
            <div className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-100 to-indigo-100 border border-blue-200 rounded-full mb-8 animate-slideInUp hover:scale-105 transition-all duration-300">
              <div className="w-3 h-3 bg-blue-500 rounded-full mr-3 animate-pulse"></div>
              <span className="text-sm font-semibold text-blue-700">Premium Software Solutions</span>
              <i className="ri-arrow-right-line ml-2 text-blue-600"></i>
            </div>
            ...
            <p className={`text-xl mb-10 text-gray-600 leading-relaxed max-w-lg transition-all duration-1000 delay-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
            ...
            <div className="flex flex-col sm:flex-row gap-6 mb-12">
              <Link 
                href="/contact"
                className="group relative px-10 py-5 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-2xl font-semibold text-lg overflow-hidden hover:shadow-2xl transition-all duration-300 whitespace-nowrap cursor-pointer animate-slideInLeft hover:scale-105"
              >
              ...
              <Link 
                href="/portfolio"
                className="group px-10 py-5 border-2 border-blue-600 text-blue-600 rounded-2xl font-semibold text-lg hover:bg-blue-600 hover:text-white transition-all duration-300 whitespace-nowrap cursor-pointer animate-slideInRight hover:scale-105"
              >
                <span className="flex items-center justify-center">
                  <i className="ri-play-circle-line mr-3 group-hover:animate-pulse"></i>
                  View Our Work
                </span>
              </Link>
            </div>
            ...
            <div className="flex items-center text-gray-500 animate-slideInUp" style={{ animationDelay: '1.2s' }}>
              <div className="w-10 h-10 border-2 border-blue-300 rounded-full flex items-center justify-center mr-4 hover:bg-blue-50 transition-colors duration-300">
          ...
          <div className={`relative transition-all duration-1000 delay-300 transform ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-12'}`}>
            <div className="relative">
              ...
              <div className="relative bg-gradient-to-br from-blue-500 to-indigo-600 rounded-3xl p-8 shadow-2xl hover:shadow-3xl transition-all duration-500 hover:scale-105">
                <div className="bg-white rounded-2xl p-8 relative overflow-hidden">
                  ...
                  <img
                    ...
                    className="w-full h-[400px] object-cover object-center rounded-xl hover:scale-110 transition-transform duration-700"
                  />
                  
                  {/* Enhanced decorative elements overlay */}
                  <div className="absolute top-4 right-4 w-16 h-16 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-2xl opacity-30 animate-pulse"></div>
                  <div className="absolute bottom-4 left-4 w-12 h-12 bg-gradient-to-r from-cyan-400 to-blue-400 rounded-xl opacity-40 animate-pulse delay-500"></div>
                  
                  {/* Additional floating elements */}
                  <div className="absolute top-1/2 left-4 w-8 h-8 bg-blue-400/20 rounded-full animate-bounce"></div>
                  <div className="absolute top-1/4 right-8 w-6 h-6 bg-indigo-400/30 rounded-lg rotate-45 animate-pulse delay-1000"></div>
                </div>
                
                {/* Enhanced floating decorative shapes */}
                <div className="absolute -top-4 -right-4 w-24 h-24 bg-gradient-to-r from-blue-400 to-indigo-400 rounded-3xl opacity-50 animate-pulse"></div>
                <div className="absolute -bottom-4 -left-4 w-20 h-20 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-2xl opacity-40 animate-pulse delay-500"></div>
                <div className="absolute top-1/2 -right-8 w-16 h-16 bg-gradient-to-r from-indigo-300 to-blue-300 rounded-full opacity-30 animate-bounce"></div>
              </div>

              {/* Enhanced floating success metrics */}
              <div className="absolute -top-8 -left-8 bg-white rounded-2xl p-6 shadow-xl border border-blue-100 animate-slideInUp hover:scale-110 transition-all duration-300 cursor-pointer" style={{ animationDelay: '1s' }}>
              ...
              <div className="absolute -bottom-8 -right-8 bg-white rounded-2xl p-6 shadow-xl border border-blue-100 animate-slideInUp hover:scale-110 transition-all duration-300 cursor-pointer" style={{ animationDelay: '1.2s' }}>
                <div className="flex items-center">
                  ...
                  <div>
                    <div className="text-sm font-semibold text-gray-900">Projects Done</div>
              ...
              <div className="absolute top-16 -right-12 bg-white rounded-2xl p-4 shadow-xl border border-blue-100 animate-slideInUp hover:scale-110 transition-all duration-300 cursor-pointer" style={{ animationDelay: '1.4s' }}>
                <div className="flex items-center mb-2">
                  {[...Array(5)].map((_, i) => (
                    <i key={i} className="ri-star-fill text-yellow-400 text-sm"></i>
                  ))}
                </div>
                <div className="text-xs text-gray-600 max-w-[120px]">"Amazing results!"</div>
