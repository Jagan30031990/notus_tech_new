  ...
  return (
    <section className="relative min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-blue-100 overflow-hidden py-10">
      ...
      <div 
        ...
        style={{
          backgroundImage: `url('https://readdy.ai/api/search-image?query=creative%20branding%20studio%20workspace%20with%20logo%20designs%2C%20color%20palettes%2C%20typography%20samples%2C%20brand%20guidelines%2C%20professional%20designers%20working%20on%20brand%20identity%2C%20modern%20creative%20environment%20with%20blue%20and%20indigo%20color%20accents&width=1920&height=1080&seq=branding-hero-bg&orientation=landscape')`,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center w-full">
          <div className="text-left">
            <div className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-100 to-indigo-100 border border-blue-200 rounded-full mb-8">
              ...
              <span className="text-sm font-semibold text-blue-700">Branding Services</span>
            </div>
            ...
            <p className="text-xl text-gray-600 mb-12 leading-relaxed max-w-2xl">
              Create a memorable brand that resonates with your audience. From logo design to complete brand strategy, we help you establish a strong brand presence across all touchpoints.
            </p>
          ...
          <div className="relative">
            <div className="relative bg-white rounded-3xl p-8 shadow-2xl border border-blue-100">
              <img
                src="https://readdy.ai/api/search-image?query=professional%20brand%20design%20showcase%20displaying%20multiple%20logo%20variations%2C%20color%20palettes%2C%20typography%20samples%2C%20business%20cards%2C%20letterheads%2C%20modern%20brand%20identity%20system%20with%20clean%20presentation&width=600&height=500&seq=branding-showcase&orientation=portrait"
