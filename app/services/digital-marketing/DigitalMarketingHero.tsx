  ...
  return (
    <section className="relative overflow-hidden py-10">
      ...
      <div 
        ...
        style={{
          backgroundImage: `url('https://readdy.ai/api/search-image?query=modern%20digital%20marketing%20workspace%20with%20multiple%20screens%20showing%20analytics%20dashboards%2C%20social%20media%20campaigns%2C%20and%20SEO%20data%2C%20clean%20office%20environment%20with%20blue%20and%20purple%20ambient%20lighting%2C%20professional%20marketing%20team%20analyzing%20data%20and%20charts%2C%20digital%20marketing%20strategy%20meeting%20with%20laptops%20and%20reports&width=1400&height=800&seq=digital-marketing-hero&orientation=landscape')`,
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-gray-900">
              <div className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-100 to-indigo-100 border border-blue-200 rounded-full mb-8">
                ...
                <span className="text-sm font-semibold text-blue-700">Data-Driven Marketing Excellence</span>
              </div>
              ...
              <p className="text-xl md:text-2xl text-gray-600 mb-8 leading-relaxed max-w-2xl">
                Drive measurable results with our comprehensive digital marketing strategies that increase brand visibility and generate qualified leads
              </p>
              ...
              <div className="grid grid-cols-3 gap-6">
                <div>
                  ...
                  <div className="text-gray-600 text-sm">Campaigns Launched</div>
                </div>
                <div>
            ...
            {/* Right Content - Marketing Channels Preview */}
            <div className="relative">
              <div className="grid grid-cols-2 gap-4">
                {[
                  { icon: "ri-search-line", title: "SEO", color: "from-blue-500 to-blue-600" },
                  { icon: "ri-advertisement-line", title: "PPC Ads", color: "from-indigo-500 to-indigo-600" },
                  { icon: "ri-share-line", title: "Social Media", color: "from-blue-400 to-indigo-500" },
                  { icon: "ri-mail-line", title: "Email Marketing", color: "from-indigo-600 to-blue-700" }
                ].map((service, index) => (
                  <div 
                    key={index}
