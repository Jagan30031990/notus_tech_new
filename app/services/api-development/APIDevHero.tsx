...
export default function APIDevHero() {
  return (
    <section className="relative min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-blue-100 overflow-hidden">
      ...
      <div 
        ...
        style={{
          backgroundImage: `url('https://readdy.ai/api/search-image?query=modern%20API%20development%20workflow%20with%20multiple%20connected%20systems%2C%20cloud%20infrastructure%20diagrams%2C%20data%20flow%20visualization%2C%20professional%20developers%20working%20with%20API%20endpoints%2C%20blue%20and%20indigo%20color%20scheme%2C%20technical%20architecture%20background%2C%20seamless%20connectivity%20illustration&width=1920&height=1080&seq=api-dev-hero-bg&orientation=landscape')`,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center w-full">
          <div className="text-left">
            <div className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-100 to-indigo-100 border border-blue-200 rounded-full mb-8">
              <i className="ri-plug-line mr-2 text-blue-600"></i>
              <span className="text-sm font-semibold text-blue-700">API Development & Integration</span>
            </div>
            ...
            <p className="text-xl text-gray-600 mb-12 leading-relaxed max-w-2xl">
              Connect your systems with powerful APIs and integrations. Build scalable, secure, and high-performance solutions that enable seamless data flow across all your platforms.
            </p>
          ...
          <div className="relative">
            <div className="relative bg-white rounded-3xl p-8 shadow-2xl border border-blue-100">
              <img
                src="https://readdy.ai/api/search-image?query=professional%20API%20development%20interface%20showing%20code%20editor%20with%20REST%20endpoints%2C%20JSON%20data%20structures%2C%20API%20documentation%2C%20multiple%20connected%20services%20diagram%2C%20modern%20development%20tools%2C%20clean%20technical%20interface%20with%20blue%20accent%20colors&width=600&height=500&seq=api-dev-interface&orientation=portrait"
                alt="API Development Interface"
            ...
            <div className="absolute -bottom-8 -left-8 bg-gradient-to-r from-indigo-600 to-blue-600 rounded-2xl p-6 text-white shadow-xl">
              ...
              <div className="text-sm opacity-90">APIs Integrated</div>
            </div>
          </div>
        </div>
      </div>
